...
**Date:** 2026-08-07
**Repository state:** branch `master`, two commits through `4c7b5f5`; active WP-09 portal work follows this snapshot
...
- WP-09 remains partial: the live dashboard, payouts, notification log, Tally UI, organisation/user administration, reusable pagination, and dispute screens are still open. The operational return/inspection/mock-refund surface now exists inside the return detail workflow.
...
| **Business web portal**              | Onboarding, catalogue review, inventory + ageing, warehouses, offers + review, orders + fulfilment actions, audit, secure JWT login, finance/commission/ledger/settlement views and support desk.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Payouts, notifications, Tally, organisation/user administration, returns/refunds/disputes and a real dashboard. **The portal home page still shows the onboarding queue rather than the permission-scoped dashboard API.**                                                                                                                            |
...
**Stage 1 — Stabilise and make honest (1–2 weeks).** Verify Flutter builds, clean stale artefacts, set up branching/PRs, regenerate the API client from OpenAPI, wire the real dashboards API into the portal home, backfill `API_CONTRACTS.md`. _(WP-01, WP-02, WP-03)_
